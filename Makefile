##############################################
# OpenWrt Makefile for Omega2HCSR04 program
#
#
...
define Package/Omega2HCSR04/description
	Measure distance using sensor HC-SR04
endef
...
define Package/Omega2HCSR04/install
	$(INSTALL_DIR) $(1)/bin
	$(INSTALL_BIN) $(PKG_BUILD_DIR)/Omega2HCSR04 $(1)/bin/
endef
...
# build a package.
$(eval $(call BuildPackage,Omega2HCSR04))